...
export const partAndWhole: ContentModule = {
  ...
  rules: [
    ...
    },
    {
      ...
      params: { whole: [3, 5], a: [1, 4] },
      answer: (p) => (p.whole as number) - (p.a as number),
      text: (p) => `Ana has ${p.whole} shells. ${p.a} ${(p.a as number) === 1 ? 'is' : 'are'} red. How many are blue?`,
      exclude: (p) => (p.a as number) >= (p.whole as number),
      distractors: 'near',
    },
    {
      ...
      params: { whole: [3, 5], a: [1, 4] },
      answer: (p) => (p.whole as number) - (p.a as number),
      text: (p) => `${p.whole} eggs in a box. ${p.a} ${(p.a as number) === 1 ? 'is' : 'are'} small. How many are big?`,
      exclude: (p) => (p.a as number) >= (p.whole as number),
      distractors: 'near',
    },
  ],
