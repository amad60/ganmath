...
|---|---|---|---|
| 14 | **Pilih maskot**: A Gan si Robot (rekomendasi) / B Cicak / C Momo si Monyet / D Bintang si Kucing | **sekarang** — tapi tidak menghambat; Fase 4–5a pakai placeholder | A — badannya terbuat dari bangun datar Unit 6, jadi maskotnya ikut mengajar. Lihat [design/mascot.md](design/mascot.md) |
